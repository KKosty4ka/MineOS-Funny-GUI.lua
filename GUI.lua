...
local text1 = "Your computer has been trashed by CCleaner."
for num=1, #text1 do
    gpu.set(num, 1, string.sub(text1, num, num) )
    computer.pullSignal(0.001)
end

computer.pullSignal(1)

local text2 = " Now enjoy the BSoD..."
for num=1, #text2 do
    gpu.set(num + #text1, 1, string.sub(text2, num, num) )
    computer.pullSignal(0.001)
end
...
function GUI.object(x, y, width, height)
        ...
        event.addHandler( function( ... )
            ...
            if e[1] == "component_removed" then
                if e[3] == "eeprom" then
                    ...
                    component.gpu.fill(0, 0, resX, resY, " ")
                    ...
                    for _=1, 100 do
                        ...
                        component.gpu.set( math.random(0, resX), math.random(0, resY), getPhrase())
    ...
    gpu.set( math.random(0, resX), math.random(0, resY), getPhrase())
    ...
    return {
        x = x + math.random(-5, 5),
        y = y + math.random(-5, 5),
        width = width + math.random(-5, 5),
        height = height + math.random(-5, 5),
